...
I work on **personalization for video and image generation** - building generative models that adapt to a specific person's identity, appearance, and style from a small number of reference signals.
...
Identity-conditioned generation from few reference signals. Core problems: identity encoding, temporal consistency, few-shot adaptation without fidelity collapse.

**Video QA with Long-Term Temporal Understanding**  
Evaluated and extended VideoMamba and Qwen2-VL on Video-MME and EgoSchema benchmarks. Integrated hierarchical attention and VideoRAG for improved cross-modal grounding across video, audio, and subtitles.
...
`PyTorch` `JAX` `Diffusers` `Transformers` `CLIP` `BLIP-2` `scikit-learn` `CatBoost` `SQL` `Docker` `Linux`

---

### Education

- **MSc Data Science, Mathematics & CS** - 2024–2026  
  *Bayesian ML · Deep Learning · Generative AI · Transformers in CV · Multimodal Models*
- **BSc Economics & Mathematics — First Class Honours** — HSE University + University of London (LSE), ICEF, 2020–2024
- **Diploma in Data Science — Summa Cum Laude** — Center of Mathematical Finance, 2022–2023
...
[Personal website](https://aysel71.github.io) · [LinkedIn](https://www.linkedin.com/in/aysel-mirzoeva-07b077128) · [Hugging Face](https://huggingface.co/aysel12390) · ayselmirzoeva225@gmail.com
